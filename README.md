...
* **Phân tích Ngôn ngữ**: Chỉ cần bôi đen bất kỳ đoạn văn bản nào trên trình duyệt, menu nổi siêu gọn `Phân tích | Dịch` sẽ xuất hiện để tự động nhận diện ngôn ngữ và cấu hình đích dịch cho Side Panel.
